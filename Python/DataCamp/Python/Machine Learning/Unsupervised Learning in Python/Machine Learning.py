...
# -*- coding:utf-8 -*-
################################################################################
# Title: Machine Learning.py                                                   #
# File: /Users/zacks/Desktop/Code/Python/Projects/Machine Learning.py          #
...
# -----                                                                        #
# Last Modified: 2020-03-01 6:11:48 am                                         #
...
# Chapter - 1: Course 6
samples = pd.read_csv('https://raw.githubusercontent.com/ZacksAmber/Code/master/Python/Projects/fishcatch.dat.txt', sep = ",", header = None)
...
# kmeans = KMeans(n_clusters = 4, samples).fit_predict()
