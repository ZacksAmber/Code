# ALY6040 - Group Project – Beijing Housing Price - Shen, Yu, Qiu
...
# 2. Add the description of the price
price <- bj.raw$price
...
head(bj.tree) # bj.tree is the data that has extra label to describe the price
...
# the same characteristics as the decision tree model, the classification
